...
import ghlogo from "../../../source/docs/assets/images/github-logo.svg"
import circlelogo from "../../../source/docs/assets/images/circleci-logo.svg"
import composerlogo from "../../../source/docs/assets/images/composer-logo.svg"
    ...
    <div className="flex-panel-group">
      <div className="flex-panel-item">
        <div className="flex-panel-body">
          <div className="flex-panel-title">
            <h4 className="info" style={{marginTop: "10px", fontSize: "larger"}}>GitHub</h4>
          ...
          <p className="topic-info__description" ><a href="https://github.com" className="external">GitHub</a> is an online service that provides cloud storage Git repositories that may be cloned and used locally, or edited directly through their web-based management interface. These features are very useful to teams collaborating on a project together.</p>
        </div>
      </div>
      <div className="flex-panel-item">
        <div className="flex-panel-body">
          <div className="flex-panel-title">
            <h4 className="info" style={{marginTop: "10px", fontSize: "larger"}}>CircleCI</h4>
            <div className="pantheon-official">
      ...
      <div className="flex-panel-item">
        <div className="flex-panel-body">
          ...
          <p className="topic-info__description"><a href="/docs/composer/" className="external">Composer</a> is a PHP dependency manager that provides an alternative, more modern way to manage the external code used by a project. For example, Composer may be used to install the plugins, modules and themes used by a Drupal or WordPress site.</p>
        </div>
      </div>
    </div>
    </>
