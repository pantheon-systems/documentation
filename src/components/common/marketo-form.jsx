...
// REVIEW: types What is happening here? @aniketbiprojit
export const MarketoForm = ({ baseUrl, munchkinId, formId, formName }) => {
  ...
  useEffect(() => {
    ...
    if (!initialized) {
      ...
      Promise.all(
        ...
        .catch(() =>
          console.log("An error ocurred loading Marketo scripts...")
        );
    }
  }, [mounted]);
