  ...
  return {
    ...
    children: [
      ...
      simpleLink('/supported-drupal', 'Drupal on Pantheon', [
        ...
        simpleLink('/drupal-configuration-management', 'Configuration Management Workflow'),
      ...
      simpleLink('/drupal-from-dist', 'Create a Drupal Site Using a Drupal Distribution'),
