---
title: "New user interface for creating sites in the Pantheon Dashboard now available"
...
![New user interface showing the creation of a WordPress site in the dashboard](../images/dashboard/create-new-site-form.png)
...
* Previously, after deployment completed, only a single button was shown for opening the new site dashboard. In the new experience, we've added next steps in context with relevant documentation links: 
  ![New user interface showing the completion of deploying a new WordPress site in the dashboard](../images/dashboard/new-site-setup-deploy-complete.png)
