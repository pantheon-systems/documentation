...
As a follow-up to our release note announcing the [removal of PHP Runtime Generation 1](/release-notes/2025/12/php-runtime-generation-1-removal-date), we're now providing specific dates for the removal from the platform.
