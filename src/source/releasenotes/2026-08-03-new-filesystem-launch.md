...
Editor's note, September 17th, 2026: the rollout of this filesystem change has been paused due to increases in site creation time. Once that latency is resolved, new site creation will resume using the updated filesystem.
