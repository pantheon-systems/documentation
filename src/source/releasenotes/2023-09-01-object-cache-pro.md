...
See Pantheon’s documentation for instructions on [how to enable Object Cache Pro](/object-cache/wordpress). Or join the [#WordPress Slack Channel](https://pantheon.io/customer-community) to connect with other customers using Object Cache Pro.
