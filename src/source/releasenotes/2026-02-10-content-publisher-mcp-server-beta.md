---
title: Content Publisher MCP Server enters Public Beta
published_date: "2026-02-10"
categories: [content-publisher, tools-apis]
---

The [Content Publisher MCP Server](https://docs.content.pantheon.io/mcp) is now in Public Beta. This integration enables AI assistants and other agentic applications to interact directly with [Content Publisher](https://docs.content.pantheon.io), streamlining content workflows through natural language commands.
...
## Getting Started
The Content Publisher MCP Server is now in public beta, available to all Content Publisher users. If you are not yet a user, you can [sign-up for a free plan on pantheon.io](https://pantheon.io/content-publisher-free-trial). For instructions on how to install and use, see the [Content Publisher MCP documentation](https://docs.content.pantheon.io/mcp).

We welcome your feedback as we continue to improve this integration. Please report any issues through our regular support channels or make feature requests through our [Pantheon Roadmap site](https://roadmap.pantheon.io).
