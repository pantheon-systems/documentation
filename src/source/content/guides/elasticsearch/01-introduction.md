...
There are currently a few known issues with the Elasticsearch integration on Pantheon in the Alpha phase. If you find any others, please let the team know in the `#beta-elasticsearch` channel in the Pantheon Community Slack.
...
During Beta, please report any issues or questions to the Pantheon team in the private `#beta-elasticsearch` channel in the Pantheon Community Slack. To request an invite, [submit this form](https://forms.gle/q5qWS17L9VsH2fkg6).
