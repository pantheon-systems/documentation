...
subtitle: Invite to Pay or Transfer of ownership
...
Use this option to send a payment request to another user, who will become the new site owner upon accepting. Follow the steps below:

1. Access your sandbox's site dashboard, through the site list.
2. Click the upgrade path, either by clicking the yellow upgrade button beside your site name.
3. Choose your desired site plan.
4. To the right of the credit card box, select the Invite to Pay tab.
