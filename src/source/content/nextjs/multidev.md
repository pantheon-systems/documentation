...
These environments are created automatically per pull request or merge request by Pantheon's External Version Control integration.
...
All code changes must be made through Git and deployed through Pantheon's External Version Control integration.
