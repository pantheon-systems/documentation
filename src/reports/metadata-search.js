                      ...
                      <th>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            placeholder="Filter"
                            onChange={(y) =>
                              setSearchContentType(y.target.value)
                            }
                      ...
                      <th>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            placeholder="Filter"
                            onChange={(b) =>
                              setSearchCategories(b.target.value)
                            }
                      ...
                      .filter((page) => {
                        return page.node.frontmatter.categories
                          ? page.node.frontmatter.categories.filter(
                              (categories) =>
                                categories.indexOf(searchCategories) >= 0
                            ).length
                          : page
                      })
                      .filter((page) => {
                      ...
                      .filter((page) => {
                        return page.node.frontmatter.integration
                          ? page.node.frontmatter.integration.filter(
                              (integration) =>
                                integration.indexOf(searchIntegration) >= 0
                            ).length
                          : page
                      })
                      .filter((page) => {
                        return page.node.frontmatter.contenttype
                          ? page.node.frontmatter.contenttype.filter(
                              (contenttype) =>
                                contenttype.indexOf(searchContentType) >= 0
                            ).length
                          : page
                      })
                      .map((page, i) => {
                          ...
                          <tr key={i}>
                            ...
                            <td>
                              {page.node.frontmatter.product
                                ? page.node.frontmatter.product.map(
                                    (product, i) => {
                                      return (
                                        <span key={i}>
                                          {(i ? ", " : "") + product}
                            ...
                            <td>
                              {page.node.frontmatter.integration
                                ? page.node.frontmatter.integration.map(
                                    (integration, i) => {
                                      return (
                                        <span key={i}>
                                          {(i ? ", " : "") + integration}
