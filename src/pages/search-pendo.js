...
class SearchPendo extends React.Component {
  componentDidMount() {
    //On page load...
  ...
  render() {
    return (
      <main id="docs-main" className="search-pendo">
        <Container width="standard" className="search-results">
          <SearchBar />
          <div className="search-pendo__heading">Search Results</div>
