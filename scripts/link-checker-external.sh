...
if ./gatsby/node_modules/broken-link-checker/bin/blc -q -r -o --rateLimit=1000 --user-agent='Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36' $exclusions http://localhost:9000/docs
then
