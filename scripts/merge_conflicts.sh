...
elif grep --binary-files=without-match --exclude="docs/*" --exclude="git-faq.md" --exclude="core-updates.md" --exclude="maintain-custom-upstream.md" --exclude="mysql-slow-log.md" "=======" $(find . -type f ); then
