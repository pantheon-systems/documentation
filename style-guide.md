...
**Example:**
We run our status checks on your site automatically once an hour. If you'd like fresher data, [run the checks now](www.pantheon.io).  
...
For detailed instructions, see [Article Title](www.pantheon.io).
...
For more information, see [Article Title](www.pantheon.io).
...
[Marketing/Brand Style Guide](https://docs.google.com/a/pantheon.io/file/d/0ByQAGaXeMZgJQmp1Yzk2SnlLdzg/edit "Pantheon google drive, Brand Style Guide")
