...
### PHP Version
The site default PHP version is applied to every environment unless a PHP version is explicitly selected for each environment. Learn more about [Upgrading PHP Versions](/docs/articles/sites/settings/upgrade-php-versions/).
