...
The following example includes Pantheon credentials ([site UUID](/docs/articles/sites#site-uuid) omitted). You can use the port numbers from this example, at a minimum, you'll need to leave port 2222 in place.
