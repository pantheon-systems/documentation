...
---
Local development has a number of advantages, especially if continuous Internet access is a concern. This article will walk you through setting up a local development environment.
