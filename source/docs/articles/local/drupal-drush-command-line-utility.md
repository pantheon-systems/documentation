...
Switch to SFTP mode, check the connection settings link for information to connect via SFTP client or CLI, and add the file. You can find your code in the ~/code directory once you connect.
