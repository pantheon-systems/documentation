...
![MySQL Credentials](https://www.getpantheon.com/sites/default/files/docs/desk_images/168060)
...
If you need to access the MySQL database credentials outside of your site, or need to implement the Domain Access module, see [Read Pantheon Environment Configuration](/docs/articles/sites/code/reading-pantheon-environment-configuration#read-pantheon-environment-configuration).
