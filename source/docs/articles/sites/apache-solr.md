...
- If you have a large number of items to index, the process may timeout if you try to submit them all in one batch. The workaround is to submit a smaller number of items in each batch.
