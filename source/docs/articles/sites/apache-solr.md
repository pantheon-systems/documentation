...
- Non-English letters and characters will not be recognized due to the fact that the Solr database is not UTF-8 encoded.  Due to this, multi-lingual search is not supported.
