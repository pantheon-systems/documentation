...
5. The **Servers** display shows the number of [DROPs](/docs/articles/architecture/all-about-application-containers#all-about-drops), or appservers, associated with the given environment.
