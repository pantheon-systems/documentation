...
5. The **Servers** display shows the number of [Application Containers](/docs/articles/architecture/all-about-application-containers#all-about-Application Containers), or appservers, associated with the given environment.
