...
<hr>
#### Plupload
**Issue**: This module uses the `tmp` directory which is not supported in a distributed environment. For more information, see [Using the tmp Directory](/docs/articles/sites/code/unsupported-modules-plugins/#using-the-tmp-directory) section below.
