...
- Apache Solr Search 
**Issue** If Acquia Solr modules are present in the site codebase (even if disabled) and Pantheon Apache Solr is enabled the site will report being unable to connect to Solr server.
**Solution** Delete Acquia Solr modules from codebase and then disable and re-enable Pantheon Apache Solr module.
