...
* Drupal 8 tackles configuration management head on. For more information, see [Configuration Workflow for Drupal 8 Sites](/docs/articles/drupal/drupal8/configuration-management/).
