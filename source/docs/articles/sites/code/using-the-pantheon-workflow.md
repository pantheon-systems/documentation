...
**Please note:** Using Workflow > Export will not include a copy of your codebase so it cannot be used as the basis to create a new site. If you wish to create a new site please use the backup files generated by <insert link to backup doc here!>.
