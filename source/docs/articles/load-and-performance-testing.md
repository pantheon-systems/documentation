...
You should [Enable New Relic](/docs/articles/sites/newrelic/new-relic-performance-analysis) to monitor internal execution performance without needing any additional modules or tools.  
...
The "Age" field should be greater than 0. If the max age is not greater than 0, please review the [documentation.](/docs/articles/drupal/drupal-s-performance-and-caching-settings#drupal-s-performance-settings) and consult the [Working With Varnish on Pantheon](/docs/articles/architecture/edge/varnish) documentation.
