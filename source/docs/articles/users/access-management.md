...
To remove a team member from a site, [follow these steps](https://pantheon.io/docs/articles/sites/team-management/#remove-a-team-member).
...
## See Also
[Accessing an Account After the Owner Leaves](/docs/articles/users/access-account-after-owner-leaves/)  
