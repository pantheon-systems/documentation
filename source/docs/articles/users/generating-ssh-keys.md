...
This error occurs when a user is attempting to make a direct connection to Pantheon via SSH. Pantheon does not support [direct SSH connections](/docs/articles/frequently-asked-questions/#does-pantheon-have-ftp-or-shell-access?).
