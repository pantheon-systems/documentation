...
This can be done by setting your file-system settings to private. These files will be accessible based on the access control rules that you set for your site and will use the following directory: `sites/default/files/private`
