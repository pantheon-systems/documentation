...
```bash
terminus wp 'core multisite-install --title=<site-title> --admin_user=<username> --admin_password=<password> --andmin-email=<email> --url=<url>' --site=<example-network> --env=dev
```
