...
You can now automatically trigger [Quicksilver](https://pantheon.io/docs/quicksilver/)  scripts from the [pantheon.upstream.yml](https://pantheon.io/docs/pantheon-yml/#custom-upstream-configurations) file when you create new sites from a [custom upstream](https://pantheon.io/docs/custom-upstream/).
