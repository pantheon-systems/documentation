...
subtitle: About
description: Learn how Pantheon Organizations can help you effectively manage a large number of sites.
categories: [manage]
tags: [accounts]
contributors: [wordsmither]
layout: guide
permalink: docs/guides/account-mgmt/organizations/
anchorid: organizations
---

Pantheon Organizations bring together users, sites, Custom Upstreams, Multidev environments, and support. If you are an Administrator or Team Member for your Organization, you can access support requests, add or remove organizational team members, and manage new or existing sites.
