...
Currently, Autopilot only supports Drush 8. Note, however, that Autopilot does not use Drush when updating an Integrated Composer site; you may therefore use any Drush version you wish when using Integrated Composer.

Refer to the documentation on [Drush versions](/drush-versions) for more information. 
