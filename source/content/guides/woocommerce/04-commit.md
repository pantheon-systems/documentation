...
<Image alt="Pantheon dashboard SFTP changes" src="guides/woocommerce/13-Pantheon-dashboard-SFTP-changes.png" />
...
<Image alt="Committing SFTP changes" src="guides/woocommerce/14-Pantheon-dashboard-commit-SFTP-changes.png" />

Once you're all done click **Commit**. When you've finished you should see your changes in the commit log:

<Image alt="Pantheon dashboard commit log" src="guides/woocommerce/15-Pantheon-dashboard-commit-log.png" />
...
<Image alt="Creating a backup on the Pantheon dashboard" src="guides/woocommerce/16-Pantheon-dashboard-create-backup.png" />
