...
1. Optional: Set or increment the current configuration version. This step can be skipped initially. Only use this is you are prompted to update the Composer config version. 
