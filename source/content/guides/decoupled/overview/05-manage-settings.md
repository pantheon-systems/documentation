...
1. [Go to the workspace](/guides/account-mgmt/workspace-sites-teams/workspaces#switch-between-workspaces)click **Sites**, and then select the site you want to change the name of.
