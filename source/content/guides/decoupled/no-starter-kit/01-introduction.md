...
You can create your Front-End Site without a starter kit, however, Pantheon provides several starter kits to streamline the process. You can also create create your Front-End Site without a CMS.
