...
This process is quite similar to the [Upgrade Pantheon Drupal 8 Sites to Drupal 9 With Integrated Composer](/docs/guides/drupal-9-migration/upgrade-to-d9) guide, except that you are staying on Drupal 8- to defer the Drupal 9 upgrade to later- and with some special considerations for custom upstreams.
