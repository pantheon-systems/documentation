...
If you're having problems cloning your Git repository, verify that the SSH key in your [Personal Settings](/guides/personal-settings) is enabled. For more information, see [Generating SSH Keys](/ssh-keys).
