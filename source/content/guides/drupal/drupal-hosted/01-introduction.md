...
This guide is intended for those who do not have access to Multidev.  If you do have access, use [Migrate a Drupal 8 Site with Multidev to Drupal:latest Using Multidev](/guides/drupal-hosted) instead.
