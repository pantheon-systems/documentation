...
Once the Pantheon Secrets service becomes generally available and merged into, the older terminus-secrets-plugin will be discontinued. If you use the older plugin to manage secrets today, we strongly encourage you to upgrade your security and experience by adopting this new feature.
