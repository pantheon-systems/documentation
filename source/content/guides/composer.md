...
- Create a new [Drupal:latest with Integrated Composer](/drupal) site.
- [Migrate or upgrade](/drupal-migration) an existing Drupal 8 or 9 site to drupal:latest with Integrated Composer.
