...
1. Select **Live** from the **From this Environment** list to clone the database and files from the Live site. 
    ...
    The Clone operation only copies the [files](/guides/filesystem/files) folder (`wp-content/uploads` or `sites/default/files`) and does not include core, theme, plugins or modules.
