...
- [Bedrock based](/guides/wordpress-composer/pre-ga/wordpress-composer-managed) or Composer based WP Multi-site is a possibility and can be discussed during onboarding
