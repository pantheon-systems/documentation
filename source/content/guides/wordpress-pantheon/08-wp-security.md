...
Our [Terminus command line tool]( /terminus/) allows you to manage everything you can do in our administrative interface by script. Pair it with [WP-0CLI](/wp-cli/) and add in our [Quicksilver hooks](/guides/quicksilver) to trigger testing, and you're on your way.
