...
1. Use persistent Object Cache
    ...
    - Reduce the load on your database and CPU overhead with [Object Cache Pro](/object-cache/wp) (included in all [Pantheon accounts](/guides/account-mgmt/plans/faq#plan-resources) above Basic).
