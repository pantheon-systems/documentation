...
1. Use persistent Object Cache
    ...
    - Reduce the load on your database and CPU overhead with [Object Cache](/guides/object-cache) (included in all [Pantheon accounts](/guides/account-mgmt/plans/faq#plan-resources) above Basic).
