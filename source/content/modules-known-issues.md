...
**Solution**:  We suggest using Pantheon if you want to set up HTTP authentication. Additionally, see [Advanced Redirects and Restrictions](/advanced-redirects) for more options to control and restrict access to some or all of your site.
