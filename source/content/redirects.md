...
AGCDN only works with custom domains and `.pantheonsite.io` domains are not covered. With AGCDN the site will not be fully protected under WAF if it is using the platform domain. A platform domain redirect to the main domain is recommended. 
