...
If you're setting [HSTS](#redirect-to-https) in `pantheon.yml`, you don't need additional PHP redirection.
...
When using this type of redirect, you must first [remove the primary domain](#update-or-remove-primary-domain) from the environment.
