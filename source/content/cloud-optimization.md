...
- **Object Caching:** By offsetting database requests [using Object Cache](/redis) as the caching backend, you can greatly reduce the number of round trips required to build a page.
