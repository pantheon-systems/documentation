...
| [All-in-One WP Migration](https://wordpress.org/plugins/all-in-one-wp-migration/) | wp-content/ai1vm-backups | The platform is not designed for large backup files, and this plugin can cause your deployment workflows to break. You can download full backups [from the Site Dashboard](http://localhost:8000/backups). See [below](http://localhost:8000/plugins-known-issues#all-in-one-wp-migration) for additional information. |
| | wp-content/plugins/all-in-one-wp-migrations/storage |
| [Autoptimize](https://wordpress.org/plugins/autoptimize/) | wp-content/resources | See the [Autoptimize](http://localhost:8000/plugins-known-issues#autoptimize) section below for other solutions. |
...
| [Wordfence](https://wordpress.org/plugins/wordfence/) | wp-content/wflogs | Follow the steps outlined in the [Wordfence](http://localhost:8000/plugins-known-issues#wordfence) section. |
...
| | wp-content/cache |
| [WPML - The WordPress Multilingual Plugin](https://wpml.org/) | wp-content/languages | Alternate solutions are listed in the [WPML section](http://localhost:8000/plugins-known-issues#wpml---the-wordpress-multilingual-plugin). |
