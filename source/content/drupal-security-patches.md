...
As an additional security measures, sites with [Multidev](/guides/multidev) environments should consider [locking](/security) them until they can be patched. If you have [Terminus](/terminus) installed on your local computer, you can lock all environments at once with the following Bash script:
