---
title: Enabling Solr 8 on Drupal 9
...
It is a best practice in Drupal 9 to export your changes to `yml` files. You can quickly export configuration changes via [Terminus](/terminus):
...
The version of Solr on Pantheon used for Drupal 9 is Apache Solr 8. 
