...
Using the `pantheon.yml` file, you can set the use and duration of the HSTS header and its effect on subdomains. Using the long duration setting will help you get an A+ SSL rating from SSL Labs, but is a committment to HTTPS and difficult to reverse this decision.
