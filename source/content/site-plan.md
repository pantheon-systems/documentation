...
[New Relic](/new-relic), [Object Cache](/object-cache) (formerly Redis), and [Pantheon Search](/pantheon-search) are not available for Basic sites. These features must be disabled in order to select Basic as the new site plan when upgrading or downgrading plans.
