...
Chapter 10 [todo link] goes into greater detail on Pantheon's Custom Upstream product that enables this layering even more effectively than traditional Multisite configurations.
...
Chapter 10 [todo link] examines how a central web team can manage shared code using Custom Upstreams to save time for a wider organization running dozens, hundreds, or thousands of sites.


#### Automating Repetitive Tasks

Performing code updates is one of the most tedious tasks in website operations where human error adds huge risk. With security updates the stakes are raised. Chapter 9 [todo link] shows Pantheon's answers.
...
Web teams frequently need to build their own specific automations. Pantheon enables that with our command line interface (Terminus) and hook system (Quicksilver) as you will see in Chapter 8 [todo link] .
...
Chapter 7 [todo link] shows how to connect with your team on Pantheon, and most critically, how to connect your DNS so that the public can find your site. It covers
...
Chapter 5 [todo link] describes the containerization model that supports highly scaled sites, and perhaps just as importantly, enables teams to move between sites (large and small) without rethinking every detail of their workflow.
...
* Chapter 4 [todo link] examines the CDN Edge layer that serves responses to visitors. With this layer standardized web teams can reach the best possible performance without extra work.
    * Full page caching
...
Let's see that process next in Chapter 3 [todo link].
