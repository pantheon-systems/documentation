...
In early testing we saw multi-second speedups in Visual Progress <Popover icon="info-circle" title="Visual Progress" content="The pace at which content renders on the visible page" /> even within the continental US. International users will benefit even more:
