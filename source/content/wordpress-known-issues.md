...
**Issue 3:** Jetpack is intended to be run on your live site. It will turn on safe mode and prevent the connection to WordPress.com if a site is already registered through Jetpack. For this reason it's best to only activate Jetpack in the **Live** environment of your site and let it run in dev mode for your **Dev** and **Test** environments. For more information, see the [Jetpack documentation on Safe Mode](https://jetpack.com/support/safe-mode/).
