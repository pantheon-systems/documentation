...
Pantheon strips cookies for any file ending with these extensions even if the file is dynamically generated by Drupal or WordPress. (png|gif|jpeg|jpg|ico|bmp|tif|tiff|webp|swf|css|js|woff|woff2|svg|ttf|otf|eot)
