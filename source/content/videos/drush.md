...
If you install Pantheon’s command line tool, [Terminus](/guides/terminus/install), you can run Drush commands from your local environment, as well as Pantheon-specific commands. I’ll be using Terminus in this video.
