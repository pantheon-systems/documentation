...
Please note that the day you select for Autopilot to run is when updates will **start** running, and does not mean the update will be complete on that day. For best results, schedule Autopilot to run the day before you plan to review test results.
