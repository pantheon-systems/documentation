...
- `.gitignore`: Prevents build artifacts generated by Composer from being committed to the upstream or site code repositories. NOTE: Changing the tracking status of composer-managed files and directories may lead to unexpected results, including failed builds.
