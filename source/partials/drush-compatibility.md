...
| 10      | 7.1+     | January 2022| ❌      |Compatible but not supported | Compatible but not supported| 
| 9      | 5.6+     | May 2020  | ❌      |Compatible but not supported |<span style="color:red">❌ </span>|
| 8     | 5.4.5+     | November 2022| <span style="color:green">✔</span>    |Supported but not recommended|<span style="color:red">❌ </span>|
| 7      | 5.3.0+     | July 2017| Compatible but not supported    |<span style="color:red">❌ </span>  |<span style="color:red">❌ </span>|
| 6      | 5.3.0+     | December 2015| Compatible but not supported    |<span style="color:red">❌ </span> |<span style="color:red">❌ </span>|
| 5     | 5.2.0+    | May 2015 | Compatible but not supported    |<span style="color:red">❌ </span>  |<span style="color:red">❌ </span> |
