...
- [Add a Client to Your Agency](/docs/add-bill-client/) for an all-in-one guide on how to add a client's site to your agency and pass on Preferred Partner pricing.
