...
**Issue**: This theme presents a form requesting FTP credentials in order to automatically update it's components. This will appear on dev, test and live environments and can be hidden via CSS, but is still present.
