...
Make sure you have the Pantheon SFTP connection information for your site ready. If you need to locate the connection information, see the documentation on [how to find the SFTP credentials](/docs/developing-directly-with-sftp-mode#sftp-connection-information) for your site.
