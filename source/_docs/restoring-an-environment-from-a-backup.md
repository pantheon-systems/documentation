...
![Backup tool](/source/assets/images/backup-tool.png)
...
![Backups and Restore Button](/source/assets/images/restore-button.png)
...
![Temporary backup link](/source/assets/images/direct-download-archive.png)
...
![Workflow Tab](/source/assets/images/workflow-tab.png)  
...
2. Copy the commit ID:
 ...
 ![commit ID](/source/assets/images/commit-id.png)
