...
| [**SSL Labs Rating**](https://www.ssllabs.com/ssltest/){.external}    | A                         | A+ [with HSTS](/docs/pantheon-yml/#enforce-https-+-hsts)     | A+ [with HSTS](/docs/pantheon-yml/#enforce-https-+-hsts) *         |
