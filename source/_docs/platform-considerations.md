...
## Domain Capacity per Environment

The Site Dashboard limits the maximum number of domains that can be connected to a single environment to 200. This should only be of note for sites that are using Drupal with Domain Access and WordPress Site Networks.
