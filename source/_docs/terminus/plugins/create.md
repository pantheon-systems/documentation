...
At this point, it would be a good idea to [configure your project tests to run automatically on Circle CI](https://circleci.com/docs/1.0/getting-started/). You'll need to keep a Free site online to run the tests against.
...
2. In the Circle CI settings, set up the following environment variables:
    ...
    - `TERMINUS_SITE`: The name of a Free Pantheon site to run tests against.
