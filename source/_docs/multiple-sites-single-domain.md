...
- Separate installs with [redirection to a subdomain](/docs/redirect-incoming-requests/#redirect-to-subdirectories-or-specific-urls)
- Features-based installs with Pantheon Enterprise [custom upstreams](/docs/adding-a-custom-upstream/) and [redirection to a subdomain](/docs/redirect-incoming-requests/#redirect-to-subdirectories-or-specific-urls)
