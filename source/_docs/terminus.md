...
Terminus 1.x does not provide a command for clearing the Redis cache. To clear the Redis cache, use the dashboard or the [Redis command-line client](https://pantheon.io/docs/redis/#clear-cache).
