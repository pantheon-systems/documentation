...
* We recommend using HTTPS. Pro plans and above can [load a certificate](/docs/enable-https/) into Pantheon. On Personal plans (or others), you can use [Cloudflare Free SSL](/docs/cloudflare/).
