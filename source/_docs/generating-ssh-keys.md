...
Instructions for generating SSH keys are different for every platform. Select your platform:
 ...
 - [Mac OS and Linux](/docs/generating-ssh-keys/#mac-os-and-linux)  
 - [Windows / Git GUI and OpenSSH](/docs/generating-ssh-keys#windows-%2F-openssh)

<!--<li>
	<p><a href="/docs/generating-ssh-keys#generating-ssh-keys#generating-keys-on-windows-and-putty">Windows / PuTTY</a></p>
	</li>-->
## Mac OS and Linux
...
4. You're now ready to [add the key to your Pantheon account](/docs/generating-ssh-keys/#add-the-key-to-your-pantheon-account).
...
For more detailed instructions on adding SSH keys, see [Loading SSH Keys](/docs/loading-ssh-keys).
...
This error occurs when a user is attempting to make a direct connection to Pantheon via SSH. Pantheon does not support <a href="/docs/frequently-asked-questions/#does-pantheon-have-ftp-or-shell-access?" data-proofer-ignore> direct SSH connections</a>.
