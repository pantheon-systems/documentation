...
<p markdown="1">This guide uses the local command line environment, and there are several variables dependant on your specific site. Before we begin, set the variable `$site` in your terminal session to match your site name:
<pre>
