...
subtitle: Single Dev Workflow: Add Code via Your CMS Admin Interface
guidepage: true
anchorid: admin
...
use:
    - gettingstartedpages
permalink: docs/guides/getting-started/admin/
nexturl: getting-started/conclusion
nextpage: Conclusion
previousurl: getting-started/add-code
previouspage: Learn How to Add or Change Code
---
