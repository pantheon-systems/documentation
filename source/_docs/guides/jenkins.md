...
4. Create another credential for a Terminus Token, using  either an existing token or [create a new token](https://pantheon.io/docs/machine-tokens) from your Jenkins user dashboard:
