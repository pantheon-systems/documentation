...
All plans except for a Basic plan can use Redis. Redis is available to Free plans for developmental purposes, but Redis will not be available going live on a Basic plan.
