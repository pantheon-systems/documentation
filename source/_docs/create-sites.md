...
This is currently not possible on the platform. Site names and Platform URLs are permanent and cannot be changed. As as a workaround, you can export your existing site and import it to a new site with the correct name. See [Cloning an Existing Pantheon Site](https://pantheon.io/docs/clone-site/).
