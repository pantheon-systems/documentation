...
A <strong><span class="glyphicons glyphicons-snowflake"></span></strong> icon in the site's status column indicates that a site is [frozen due to inactivity](/docs/platform-considerations/#inactive-site-freezing).
