...
<h4>Note</h4>
Replace <code>Example-Org-Name</code> with your Pantheon organization name. Separate words with hyphens, and append SSO. The connection name must start with an alphanumeric character, and can only contain alphanumeric characters and '-'. 
