...
categories: [drupal]
---
By default, Pantheon runs Drush 8.x on newly created Drupal sites, and 5.x on sites created prior to November 4, 2015. Alias files generated by Pantheon are not compatible with 6.x; however, you can execute commands locally with this version by including the `--strict=0` option.

<div class="alert alert-info" role="alert">
<h4 class="info">Note</h4>
<p markdown="1">
When running Drush locally, we highly recommend running Drush version 8.16 or higher, although 7.x is also supported for Drupal 7 sites.
</p></div>
