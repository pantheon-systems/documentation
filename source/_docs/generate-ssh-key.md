...
---
Pantheon does not support the SSH protocol. <!--You can not connect via SSH using Putty.--> These directions allow you to have passwordless access if you configure Git, SFTP, or Drush to use SSH keys.
...
Instructions for generating SSH keys are different for every platform. Select your platform:
 ...
 - [Mac OS and Linux](/docs/generate-ssh-key/#mac-os-and-linux)  
 - [Windows / Git GUI and OpenSSH](/docs/generate-ssh-key#windows-%2F-openssh)

<!--<li>
	<p><a href="/docs/generate-ssh-key#generate-ssh-key#generating-keys-on-windows-and-putty">Windows / PuTTY</a></p>
	</li>-->
## Mac OS and Linux
...
4. You're now ready to [add the key to your Pantheon account](/docs/generate-ssh-key/#add-the-key-to-your-pantheon-account).
...
For more detailed instructions on adding SSH keys, see [Loading SSH Keys](/docs/add-ssh-key).
