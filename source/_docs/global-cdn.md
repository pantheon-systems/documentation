...
Hit rates are not currently available, however you can measure traffic for the Live environment. For details, see [Metrics in the Site Dashboard](/docs/metrics/).
