...
### Drupal
Sites running Drupal 6/7 must enable the [pantheon\_api](/docs/pantheon_api-module/) module to allow Drupal to send the request to clear the Varnish caches. Drupal 8 sites must clear Varnish via the Pantheon Dashboard.
