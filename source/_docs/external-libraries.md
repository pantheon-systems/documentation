...
Download and install the Search API Attachments module (search_api_attachments) then you'll need to configure the module's settings.
...
The last step is to verify that your site is able to extract text from documents. Click **Submit and test extraction**.

If everything is working correctly, you will see a _"Extracted data: Congratulations! The extraction seems working! Yay!"_ success message.
