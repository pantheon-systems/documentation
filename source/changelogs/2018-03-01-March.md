...
### Terminus 1.8
If you haven’t updated Terminus recently, check out the [Terminus Changelog](/guides/terminus/updates/#changelog) to see what’s new and update to the [current release](/guides/terminus/updates/#update-to-the-current-release).
