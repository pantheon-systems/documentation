...
[Localdev 0.10.0](/guides/localdev/troubleshoot-support) has been released, including a new log and activity viewer, UX improvements, and bug fixes. For more information, see the [Localdev documentation](/guides/localdev/troubleshoot-support).
