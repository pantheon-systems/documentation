...
Support Guide - Support details for Pantheon products and features are now available in a structured and detailed guide. You can also checkout the documentation on Support in the New Dashboard. Unified Support in the New Dashboard simplifies the user experience for getting support on the Pantheon platform and offers users ease of access to the various support channels. It also includes the option for Diamond and Platinum customers, to contact the new call center, if needed. For more information on Support in the New Dashboard, refer to the documentation.
